...
namespace Ektron.PFWidgets.ContentBlock
{
    ...
    public class CBHandler : IHttpHandler
    {
        ...
        public string search()
        {
            ...
            {
                if (t.ContentSubType != Ektron.Cms.Common.EkEnumeration.CMSContentSubtype.PageBuilderData && t.ContentSubType != Ektron.Cms.Common.EkEnumeration.CMSContentSubtype.PageBuilderMasterData && t.ContentSubType !=EkEnumeration.CMSContentSubtype.CTAData)
                    items.Add(t);
            }
        ...
        public string getchildfolders()
        {
            ...
            // Support CampaignManagement Folders
            if (request.objectType == "folder" && !(id < 0 && !(id <= -101 && id  >= -112)))
            {
        ...
        public string gettaxonomycontent()
        {
            ...
            if (request.objectType == "taxonomy" && request.objectID > -1)
            {
                ...
                if (taxdata != null)
                {
                    ...
                    {
                        return (t.ContentSubType != Ektron.Cms.Common.EkEnumeration.CMSContentSubtype.PageBuilderData && t.ContentSubType != Ektron.Cms.Common.EkEnumeration.CMSContentSubtype.PageBuilderMasterData && t.ContentSubType != EkEnumeration.CMSContentSubtype.CTAData)
