            ...
            <div class="CBEdit">
                <div class="responsiveImageWidget-info clearfix">
                    ...
                    <div class="responsiveImageWidget-Fields clearfix">
                        ...
                        <ektronUI:Label ID="uxLinkWrapLabel" AssociatedControlID="uxLinkWrap" CssClass="responsiveImageWidget-label" Text="Image To Link:" runat="server" />
                        <asp:CheckBox ID="uxLinkWrap" runat="server" style="margin-left:5%" Checked="False" />
                        <p></p>
                        <ektronUI:Label ID="uxLinkLabel" AssociatedControlID="uxLink" CssClass="responsiveImageWidget-label" Text="Link:" runat="server" />
                        <asp:TextBox ID="uxLink" CssClass="imgborder" runat="server" Text="/"></asp:TextBox>
                    </div>
                </div>
